...
public class PaperPlatformTypeAdapter extends BukkitPlatformTypeAdapter {
    ...
    @Override
    public PaperPlatformPlayer player(Object handle) throws IllegalArgumentException {
    ...
    @Override
    public PaperPlatformItem item(Object handle) throws IllegalArgumentException {
        if (handle == null) return null;
