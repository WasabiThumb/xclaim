...
public class PaperPlatformBossBar implements PlatformBossBar {
    ...
    public static @NotNull PaperPlatformBossBar create(
            @NotNull Component text,
            float progress,
            @NotNull Color color,
            @NotNull Overlay overlay
    ) {
        return new PaperPlatformBossBar(BossBar.bossBar(
                text,
                progress,
                COLOR_MAP.get(color),
    ...
    public PaperPlatformBossBar(@NotNull BossBar handle) {
        this.handle = handle;
    ...
    @Override
    public @NotNull PaperPlatformBossBar progress(float value) {
