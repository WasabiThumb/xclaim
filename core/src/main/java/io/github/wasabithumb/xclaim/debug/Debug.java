package io.github.wasabithumb.xclaim.debug;
...
public final class Debug {
    ...
    private static final String PACKAGE_PREFIX = "io/github/wasabithumb/xclaim";
    private static final int PACKAGE_PREFIX_LENGTH = 28;
    ...
    private static String[] getPackageList() throws IOException {
        ...
        try (FileInputStream fis = new FileInputStream(CODE_SOURCE);
            ...
            ZipEntry ze;
            String name;
            StringBuilder sb = new StringBuilder(PACKAGE_PREFIX_LENGTH);
            char c;
            for (int i=0; i < PACKAGE_PREFIX_LENGTH; i++) {
                c = PACKAGE_PREFIX.charAt(i);
                sb.append(c == '/' ? '.' : c);
            }
