...
@ApiStatus.Internal
public final class UseStorageClaimEnforcer extends ClaimEnforcer.ForPermission {

    public UseStorageClaimEnforcer(@NotNull ClaimManager manager) {
        super(manager);
    }

    @Override
    protected @NotNull Permission permission() {
        return Permission.USE_STORAGE;
    }
