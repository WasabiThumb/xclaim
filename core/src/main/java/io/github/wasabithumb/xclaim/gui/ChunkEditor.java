...
import io.github.wasabithumb.xclaim.api.event.XClaimAddChunkToClaimEvent;
import io.github.wasabithumb.xclaim.api.event.XClaimEvent;
import io.github.wasabithumb.xclaim.api.event.XClaimRemoveChunkFromClaimEvent;
import io.github.wasabithumb.xclaim.config.struct.sub.RulesConfig;
import io.github.wasabithumb.xclaim.economy.Economy;
import io.github.wasabithumb.xclaim.particle.ParticleBuilder;
import io.github.wasabithumb.xclaim.particle.ParticleEffect;
import io.github.wasabithumb.xclaim.platform.*;
import io.github.wasabithumb.xclaim.platform.legacy.PlatformItemPickupListener;
import io.github.wasabithumb.xclaim.platform.legacy.PlatformNamespacedKey;
...
import io.github.wasabithumb.xclaim.protection.ProtectionRegion;
import io.github.wasabithumb.xclaim.protection.ProtectionService;
...
public class ChunkEditor {
    ...
    public static class Events implements Listener {
        ...
        public void onDamage(@NotNull EntityDamageEvent event) {
            ...
            try {
                damage = io.github.wasabithumb.xclaim.util.AttributeUtil.scaleDamage(
                        damage,
