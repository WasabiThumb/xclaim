...
public class CommandManager {
    ...
    public static class Handler implements CommandExecutor, TabCompleter {
        ...
        private static class Resolution {
            private final io.github.wasabithumb.xclaim.command.Command cmd;
            private final String[] args;

            Resolution(@NotNull io.github.wasabithumb.xclaim.command.Command cmd, @NotNull String[] args) {
                this.cmd = cmd;
                this.args = args;
            }

            @NotNull io.github.wasabithumb.xclaim.command.Command cmd() {
                return cmd;
            }
        ...
        private Handler(@NotNull io.github.wasabithumb.xclaim.command.Command command) {
            cmd = command;
            bukkitCmd = XClaim.instance.getCommand(command.getName());
        }

        private Resolution resolveSubcommands(@NotNull io.github.wasabithumb.xclaim.command.Command root, @NotNull String[] args) {
            io.github.wasabithumb.xclaim.command.Command cmd = root;
            while (true) {
                boolean fullyResolved = true;
                if (args.length >= 1) {
                    String n = args[0];
                    Collection<io.github.wasabithumb.xclaim.command.Command> sub = cmd.getSubCommands();
                    if (sub != null) {
                        for (io.github.wasabithumb.xclaim.command.Command candidate : sub) {
        ...
        public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
            ...
            io.github.wasabithumb.xclaim.command.Command cmd = res.cmd();
            args = res.args();
        ...
        public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String alias, @NotNull String[] args) {
            ...
            if (idx == 0) {
                Collection<io.github.wasabithumb.xclaim.command.Command> sub = cmd.getSubCommands();
                if (sub != null) {
                    for (io.github.wasabithumb.xclaim.command.Command c : sub) entries.add(c.getName());
                }
            }
        ...
        public @NotNull io.github.wasabithumb.xclaim.command.Command getCommand() {
            return cmd;
        }
    ...
    public void register(@NotNull io.github.wasabithumb.xclaim.command.Command command) {
    ...
    public void unregister(@NotNull io.github.wasabithumb.xclaim.command.Command command) {
    ...
    public void registerDefaults() {
        Reflections reflections = new Reflections("io.github.wasabithumb.xclaim.command");
        Set<Class<? extends io.github.wasabithumb.xclaim.command.Command>> set = reflections.getSubTypesOf(io.github.wasabithumb.xclaim.command.Command.class);
        for (Class<? extends io.github.wasabithumb.xclaim.command.Command> clazz : set) {
            ...
            Constructor<? extends io.github.wasabithumb.xclaim.command.Command> con;
            try {
            ...
            io.github.wasabithumb.xclaim.command.Command com;
            try {
                com = con.newInstance();
