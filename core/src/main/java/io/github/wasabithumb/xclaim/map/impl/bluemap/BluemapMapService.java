package io.github.wasabithumb.xclaim.map.impl.bluemap;

import io.github.wasabithumb.xclaim.api.Claim;
import io.github.wasabithumb.xclaim.map.MapMarker;
import io.github.wasabithumb.xclaim.map.MapService;
import io.github.wasabithumb.xclaim.map.MapServiceOp;
import io.github.wasabithumb.xclaim.map.exception.MapServiceInitException;
...
public class BluemapMapService extends MapService {
    ...
    public BluemapMapService() throws MapServiceInitException {
        Class<?> trackerClass = this.findClass("io.github.wasabithumb.xclaim.map.impl.bluemap.BluemapAPITracker", Object.class);
    ...
    private @Nullable MapMarker getMarker(@NotNull Claim claim, @NotNull Object instance) {
        try {
            return (MapMarker) Class.forName("io.github.wasabithumb.xclaim.map.impl.bluemap.BluemapMapMarker")
    ...
    public void cleanup() {
        ...
        try {
            Class.forName("io.github.wasabithumb.xclaim.map.impl.bluemap.BluemapMapMarker")
