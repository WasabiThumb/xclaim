...
abstract class AbstractSquaremapMapIntegration implements MapIntegration {
    ...
    @IntegrationInject
    protected PlatformTypeAdapter adapter;

    //

    public AbstractSquaremapMapIntegration() {
        Squaremap api = this.load();
    ...
    protected abstract @Nullable Squaremap load();

    protected abstract @Nullable WorldIdentifier getWorldIdentifier(@NotNull Claim claim);
    ...
    public @Nullable MapMarker getMarker(@NotNull Claim claim) {
        WorldIdentifier wid = this.getWorldIdentifier(claim);
