package io.github.wasabithumb.xclaim.economy;
...
public abstract class Economy {
    ...
    private static void internalGet() {
        try {
            instance = new io.github.wasabithumb.xclaim.economy.impl.VaultEconomy();
            return;
        } catch (Throwable ignored) {
        }
        try {
            instance = new io.github.wasabithumb.xclaim.economy.impl.EssentialsEconomy();
        } catch (Throwable ignored) {
        }
    }
