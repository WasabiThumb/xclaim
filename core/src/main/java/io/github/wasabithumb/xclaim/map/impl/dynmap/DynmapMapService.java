package io.github.wasabithumb.xclaim.map.impl.dynmap;
...
public class DynmapMapService extends MapService {
    ...
    public @Nullable MapMarker getMarker(@NotNull Claim claim) {
        try {
            ...
            return (MapMarker) Class.forName("io.github.wasabithumb.xclaim.map.impl.dynmap.DynmapMapMarker")
    ...
    public void cleanup() {
        try {
            Class<?> apiClass = Class.forName("org.dynmap.DynmapAPI");
            Class.forName("io.github.wasabithumb.xclaim.map.impl.dynmap.DynmapMapMarker")
