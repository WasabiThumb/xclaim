package io.github.wasabithumb.xclaim.protection.impl.worldguard;
...
import io.github.wasabithumb.xclaim.util.service.ServiceInitException;
...
public class WorldGuardProtectionService extends ProtectionService {
    ...
    public Collection<ProtectionRegion> getRegionsAt(Chunk chunk) {
        ...
        for (com.sk89q.worldguard.protection.regions.ProtectedRegion region : manager.getRegions().values()) {
            ...
            ret.add(new io.github.wasabithumb.xclaim.protection.impl.worldguard.WorldGuardProtectionRegion(
                    region,
                    this.plugin
            ));
        }
