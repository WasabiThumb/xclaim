...
@ApiStatus.Internal
public final class ClaimMaxPlaceholder extends AbstractPlaceholder {

    public ClaimMaxPlaceholder(@NotNull XClaim runtime) {
        super(runtime);
    }
    ...
    public @NotNull String resolve(@NotNull PlatformUser user, @NotNull PlaceholderArgumentQueue args) {
        return Integer.toString(this.rules().maxClaims(user));
    }
